...
choice = InlineKeyboardMarkup(
    inline_keyboard=[
        [  # 1 row
            InlineKeyboardButton(text="peer", callback_data=MyCallback(text="apple", value=12).pack()),
            InlineKeyboardButton(text="apples", callback_data=MyCallback(text="pear", value=42).pack()),
        ],
        [  # 2 row
