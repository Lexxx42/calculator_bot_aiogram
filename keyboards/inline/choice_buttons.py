...
from calculator_bot_aiogram.keyboards.inline.callback_datas import MyCallback, Function, Operation
...
choice = InlineKeyboardMarkup(
    inline_keyboard=[
        [  # 1 row
            ...
            InlineKeyboardButton(text="C", callback_data=Function(text="C").pack()),
        ...
        [  # 3 row
            ...
            InlineKeyboardButton(text="1", callback_data=MyCallback(text="1", value=1).pack()),
            InlineKeyboardButton(text="*", callback_data=Operation(text="*").pack()),
            InlineKeyboardButton(text="-", callback_data=Operation(text="-").pack()),
